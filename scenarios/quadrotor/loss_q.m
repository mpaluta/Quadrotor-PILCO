%% loss_q.m
% *Summary:* quadrotor loss function; the loss is 
% $1-\exp(-0.5*d^2*a)$,  where $a>0$ and  $d^2$ is an abstract distance
...
%
%
%   function [L, dLdm, dLds, S2] = loss_t2(cost, m, s)
%
%
% *Input arguments:*
%
...
function [L, dLdm, dLds, S2] = loss_q(cost, m, s)
%% Code
